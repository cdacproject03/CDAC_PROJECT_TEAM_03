...
<link href="/css/aboutuss.css" rel='stylesheet'>
</head>
<body>
   ...
   <div class="container">
    <div class="row">
        <div class="col-md-12">
         ...
         <p class="image-aboutus-para">SOCIAL HELP-CARE PORTAL</p>
       </div>
    </div>
</div>
</div>
    ...
    <div class="container">
        <div class="row">
                	<div class="col-md-6">
                        ...
                        <p class="lead">Medium to give and get help<br>easy and quick </p>
                    </div>
                    <div class="col-md-6">
                    	<p>The main objective behind implementing this portal is to provide the helpful services to 
                            Needy Person and those Events,Services was created by NGO's & SocialWorker So our website is playing  
                            a role of a mediator between NGO's and Needy Person.</p>
                        <p>Here We Provide New arrival Events,
                    Easyily apply to services and upon there required information we provide suggestion Events(Addevrtisement) 
                    Any one can contribute Help Or Volunteer for Good job.</p>
                    </div>
</div>
    </div>
</div>
...
<div class="footer-section">
	...
	<div class="container">
		<div class="col-md-4 footer-one">
			<h5>About Us </h5>
		    <p>This site will provide information to Person who seek for help of various welfare schemes launched by NGO's 
                            & will allow them to register at our web portal.</p>
		    	<div class="social-icons"> 
               <a href="https://www.facebook.com/"><i id="social-fb" class="fa fa-facebook-square fa-3x social"></i></a>
               <a href="https://twitter.com/"><i id="social-tw" class="fa fa-twitter-square fa-3x social"></i></a>
	            <a href="https://plus.google.com/"><i id="social-gp" class="fa fa-google-plus-square fa-3x social"></i></a>
